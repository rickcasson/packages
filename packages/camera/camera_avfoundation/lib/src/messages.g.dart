...
class PlatformAVCameraDescription {
  ...
  PlatformAVCaptureDeviceType captureDeviceType;
  ...
  static PlatformAVCameraDescription decode(Object result) {
    result as List<Object?>;
    return PlatformAVCameraDescription(
      name: result[0]! as String,
      lensDirection: result[1]! as PlatformCameraLensDirection,
      captureDeviceType: result[2]! as PlatformAVCaptureDeviceType,
    );
  }
}
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
    ...
    }    else if (value is PlatformAVCaptureDeviceType) {
      buffer.putUint8(130);
      writeValue(buffer, value.index);
      ...
      buffer.putUint8(137);
      writeValue(buffer, value.index);
    }    else if (value is PlatformAVCameraDescription) {
      buffer.putUint8(138);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 130: 
        final int? value = readValue(buffer) as int?;
        return value == null ? null : PlatformAVCaptureDeviceType.values[value];
      case 131: 
        final int? value = readValue(buffer) as int?;
      ...
      case 138: 
        return PlatformAVCameraDescription.decode(readValue(buffer)!);
      case 139: 
...
class CameraApi {
  ...
  Future<List<PlatformAVCameraDescription>> getAvailableCameras() async {
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as List<Object?>?)!.cast<PlatformAVCameraDescription>();
    }
  }
