...
class PlatformAVCameraDescription {
  ...
  static PlatformAVCameraDescription decode(Object result) {
    ...
    return PlatformAVCameraDescription(
      ...
      captureDeviceType: PlatformAVCaptureDeviceType.values[result[2]! as int],
    );
  }
}
...
class _CameraApiCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is PlatformAVCameraDescription) {
      buffer.putUint8(128);
...
class CameraApi {
  ...
  Future<List<PlatformAVCameraDescription?>> getAvailableCameras() async {
    ...
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as List<Object?>?)!.cast<PlatformAVCameraDescription?>();
    }
  }
