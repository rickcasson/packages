...
typedef NS_ENUM(NSUInteger, FCPPlatformAVCaptureDeviceType) {
  /// A built-in wide-angle camera device type.
  FCPPlatformAVCaptureDeviceTypeBuiltInWideAngleCamera = 0,
  /// A built-in camera device type with a shorter focal length than a wide-angle camera.
  FCPPlatformAVCaptureDeviceTypeBuiltInUltraWideCamera = 1,
  /// A built-in camera device type with a longer focal length than a wide-angle camera.
  FCPPlatformAVCaptureDeviceTypeBuiltInTelephotoCamera = 2,
  /// A built-in camera device type that consists of a wide-angle and telephoto camera.
  FCPPlatformAVCaptureDeviceTypeBuiltInDualCamera = 3,
  /// A built-in camera device type that consists of two cameras of fixed focal length, one ultrawide angle and one wide angle.
  FCPPlatformAVCaptureDeviceTypeBuiltInDualWideCamera = 4,
  ...
  FCPPlatformAVCaptureDeviceTypeBuiltInTripleCamera = 5,
  /// A Continuity Camera device type.
  FCPPlatformAVCaptureDeviceTypeContinuityCamera = 6,
  /// An external device type.
  FCPPlatformAVCaptureDeviceTypeExternal = 7,
  /// A device that consists of two cameras, one LiDAR and one YUV.
  FCPPlatformAVCaptureDeviceTypeBuiltInLiDARDepthCamera = 8,
  /// A device that consists of two cameras, one Infrared and one YUV.
  FCPPlatformAVCaptureDeviceTypeBuiltInTrueDepthCamera = 9,
};

/// Wrapper for FCPPlatformAVCaptureDeviceType to allow for nullability.
@interface FCPPlatformAVCaptureDeviceTypeBox : NSObject
@property(nonatomic, assign) FCPPlatformAVCaptureDeviceType value;
...
@property(nonatomic, assign) FCPPlatformAVCaptureDeviceType captureDeviceType;
@end
...
- (void)availableCamerasWithCompletion:(void (^)(NSArray<FCPPlatformAVCameraDescription *> *_Nullable, FlutterError *_Nullable))completion;
