...
+ (FCPPlatformAVCameraDescription *)fromList:(NSArray *)list;
+ (nullable FCPPlatformAVCameraDescription *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end
...
+ (FCPPlatformAVCameraDescription *)fromList:(NSArray *)list {
  ...
  pigeonResult.captureDeviceType = [GetNullableObjectAtIndex(list, 2) integerValue];
  return pigeonResult;
}
+ (nullable FCPPlatformAVCameraDescription *)nullableFromList:(NSArray *)list {
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[FCPPlatformAVCameraDescription class]]) {
    [self writeByte:128];
