...
@implementation FCPPlatformAVCaptureDeviceTypeBox
- (instancetype)initWithValue:(FCPPlatformAVCaptureDeviceType)value {
  self = [super init];
  if (self) {
    _value = value;
  }
...
@interface FCPPlatformAVCameraDescription ()
+ (FCPPlatformAVCameraDescription *)fromList:(NSArray<id> *)list;
+ (nullable FCPPlatformAVCameraDescription *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
@implementation FCPPlatformAVCameraDescription
+ (instancetype)makeWithName:(NSString *)name
    lensDirection:(FCPPlatformCameraLensDirection)lensDirection
    captureDeviceType:(FCPPlatformAVCaptureDeviceType)captureDeviceType {
  FCPPlatformAVCameraDescription* pigeonResult = [[FCPPlatformAVCameraDescription alloc] init];
  pigeonResult.name = name;
  pigeonResult.lensDirection = lensDirection;
  pigeonResult.captureDeviceType = captureDeviceType;
  return pigeonResult;
}
+ (FCPPlatformAVCameraDescription *)fromList:(NSArray<id> *)list {
  FCPPlatformAVCameraDescription *pigeonResult = [[FCPPlatformAVCameraDescription alloc] init];
  ...
  FCPPlatformAVCaptureDeviceTypeBox *boxedFCPPlatformAVCaptureDeviceType = GetNullableObjectAtIndex(list, 2);
  pigeonResult.captureDeviceType = boxedFCPPlatformAVCaptureDeviceType.value;
  return pigeonResult;
}
+ (nullable FCPPlatformAVCameraDescription *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [FCPPlatformAVCameraDescription fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    self.name ?: [NSNull null],
    [[FCPPlatformCameraLensDirectionBox alloc] initWithValue:self.lensDirection],
    [[FCPPlatformAVCaptureDeviceTypeBox alloc] initWithValue:self.captureDeviceType],
  ];
}
@end
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 130: {
      NSNumber *enumAsNumber = [self readValue];
      return enumAsNumber == nil ? nil : [[FCPPlatformAVCaptureDeviceTypeBox alloc] initWithValue:[enumAsNumber integerValue]];
    }
    case 131: {
      NSNumber *enumAsNumber = [self readValue];
    ...
    case 138: 
      return [FCPPlatformAVCameraDescription fromList:[self readValue]];
    case 139: 
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[FCPPlatformCameraLensDirectionBox class]]) {
  ...
  } else if ([value isKindOfClass:[FCPPlatformAVCaptureDeviceTypeBox class]]) {
    FCPPlatformAVCaptureDeviceTypeBox *box = (FCPPlatformAVCaptureDeviceTypeBox *)value;
    [self writeByte:130];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
    ...
    [self writeByte:137];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
  } else if ([value isKindOfClass:[FCPPlatformAVCameraDescription class]]) {
    [self writeByte:138];
  ...
  /// Returns the list of available cameras.
  {
    ...
    if (api) {
      ...
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        [api availableCamerasWithCompletion:^(NSArray<FCPPlatformAVCameraDescription *> *_Nullable output, FlutterError *_Nullable error) {
